...
public static WebDriver startBrowser()throws Throwable
{
	...
	{
		System.setProperty("webdriver.chrome.driver", "E:\\OjtAutomation_Framework\\ERP_StockAccounting\\CommonDrivers\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.manage().window().maximize();
	}
	else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
	{
		System.setProperty("webdriver.gecko.driver", "E:\\OjtAutomation_Framework\\ERP_StockAccounting\\CommonDrivers\\geckodriver.exe");
...
throws Throwable{
	...
	FileWriter fw = new FileWriter("E:\\OjtAutomation_Framework\\ERP_StockAccounting\\CaptureData\\supnumber.txt");
...
public static void supTableValidation(WebDriver driver,String column)throws Throwable
{
	...
	FileReader fr = new FileReader("E:\\OjtAutomation_Framework\\ERP_StockAccounting\\CaptureData\\supnumber.txt");
